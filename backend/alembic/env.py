...
from dfm_bq_load_alerter.db import models  # noqa: F401 — register models for autogenerate
...
def get_url() -> str:
    ...
    raise RuntimeError(
        "DFM_ALERT_POSTGRES_DSN is not configured. Set it before running alembic."
    )
